...
function twentysixteen_upgrade_notice() {
	...
	$message = sprintf( __( 'Twenty Sixteen requires at least WordPress version 4.4. You are running version %s. Please upgrade and try again.', 'kepya-webs' ), $GLOBALS['wp_version'] );
...
function twentysixteen_customize() {
	wp_die(
		/* translators: %s: The current WordPress version. */
		sprintf( __( 'Twenty Sixteen requires at least WordPress version 4.4. You are running version %s. Please upgrade and try again.', 'kepya-webs' ), $GLOBALS['wp_version'] ),
		'',
		array(
			'back_link' => true,
		)
...
function twentysixteen_preview() {
	if ( isset( $_GET['preview'] ) ) {
		/* translators: %s: The current WordPress version. */
		wp_die( sprintf( __( 'Twenty Sixteen requires at least WordPress version 4.4. You are running version %s. Please upgrade and try again.', 'kepya-webs' ), $GLOBALS['wp_version'] ) );
	}
}
